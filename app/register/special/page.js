...
// Standalone special-needs registration form — deliberately not linked from
// anywhere in the app (not the home page, not /admin, not /register itself).
// Same public access level as /register (no password). Reuses the exact
// same 4-step form; the only differences are has_special_needs is fixed to
// true (not asked as a yes/no question) and its details field is always
// visible and required, instead of the admin-only conditional field used
